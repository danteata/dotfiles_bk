...
"
"	This is the personal .vimrc file of Daniel Abakah customized from Steve Francia.
...
" Vim UI {
    ...
    set list
    set listchars=tab:>.,trail:.,extends:#,nbsp:. " Highlight problematic whit373|            """ Fuzzy Find file, tree, buffer, line
